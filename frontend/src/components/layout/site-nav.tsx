...
export function SiteNav() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-[var(--bg)]/85 backdrop-blur-sm">
      <nav className="mx-auto max-w-[1240px] px-6 sm:px-10 lg:px-12 h-16 flex items-center justify-between gap-6">
        <div className="flex items-center gap-3 min-w-0">
          ...
          >
            <span className="font-medium text-foreground">genai-labs</span>
            <span className="text-[var(--ink-dim)]">/</span>
            <span className="text-[var(--ink-muted)]">analytics-pipeline</span>
          </Link>
