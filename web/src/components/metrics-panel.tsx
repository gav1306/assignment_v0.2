...
import { deltaIsImprovement, formatDeltaPct, formatMs, formatTokens } from "@/lib/format";
...
function MetricRow({ label, baselineDisplay, optimizedDisplay, delta, improved }: MetricRowProps) {
  return (
    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-xs text-muted-foreground">
          Lower is better for both latency and tokens. Baseline often reports 0 tokens
          because its token-counting logic is unimplemented (the C4 bug we
          deliberately preserved) — the call still happens, the cost just isn&apos;t
          tracked.
        </p>
      </CardHeader>
