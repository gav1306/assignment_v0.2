...
import type { StageEvent, StageName, StageStatus } from "@/lib/types";
...
function PayloadView({ stage, payload }: { stage: StageName; payload: Record<string, unknown> }) {
...
export function StageCard({ stage, event, expectedRunning = false }: StageCardProps) {
